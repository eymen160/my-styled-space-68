    ...
    <section id="about" className="py-20 md:py-28 bg-card/30 relative overflow-hidden" ref={ref}>
      ...
      <div className="absolute inset-0 pointer-events-none">
        <motion.div 
          ...
          className="absolute top-0 right-0 w-[600px] h-[600px] rounded-full bg-gradient-to-bl from-accent/30 via-blue-500/15 to-transparent blur-[100px]" 
        />
        <motion.div 
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.1 }}
          transition={{ duration: 1, delay: 0.3 }}
          className="absolute bottom-0 left-0 w-[500px] h-[500px] rounded-full bg-gradient-to-tr from-emerald-500/20 via-blue-500/10 to-transparent blur-[100px]" 
        />
      </div>
        ...
        >
          ...
          <div className="grid lg:grid-cols-5 gap-12 lg:gap-16">
            ...
            <motion.div variants={itemVariants} className="lg:col-span-2 space-y-6">
              <div className="space-y-5 text-lg text-muted-foreground leading-relaxed p-6 rounded-2xl bg-background/40 backdrop-blur-sm border border-border/50">
                <p>
              ...
              <div className="grid grid-cols-3 gap-4 pt-2">
                {[
                  ...
                  <motion.div
                    ...
                    className="text-center p-4 rounded-2xl bg-background/60 backdrop-blur-sm border border-border/50 hover:border-accent/40 transition-all duration-300"
                  >
            ...
            <div className="lg:col-span-3 space-y-8">
              ...
              {skillCategories.map((group, groupIndex) => (
                <motion.div
                  ...
                  className="p-6 rounded-2xl bg-background/60 border border-border/50 backdrop-blur-sm hover:border-accent/30 transition-all duration-300"
                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {group.items.map((skill, index) => (
                      <motion.span
                        ...
                        transition={{
                          duration: 0.4,
                          delay: 0.3 + groupIndex * 0.1 + index * 0.03,
                        }}
