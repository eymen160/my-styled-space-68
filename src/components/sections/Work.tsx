...
const projects = [
  {
    ...
    body: "Extended U-Net research to fovea localization on the IDRiD dataset. A custom augmentation pipeline and training strategy that outperforms the published MCAU-Net benchmark — directly advancing early diabetic retinopathy screening tools.",
    metrics: [
      { v: "84.97%", l: "Model Accuracy", accent: true },
      { v: "Beat", l: "MCAU-Net", accent: true },
      { v: "IDRiD", l: "Dataset" },
    ],
  ...
  {
    id: "02",
    title: "AI Stock Sentiment Trading",
    role: "FinTech · Machine Learning",
    body: "Three models working together: FinBERT reads financial news sentiment, an LSTM forecasts price movement, and a Random Forest generates trade signals — all unified in a live Streamlit dashboard.",
    metrics: [
  ...
  },
  {
    ...
    body: "U-Net with ResNet34 encoder trained on REFUGE2. A rigorous augmentation strategy pushed performance past every comparable published baseline by 2.7 percentage points.",
    metrics: [
