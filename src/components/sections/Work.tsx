...
const projects = [
  {
    ...
    description:
      "Built U-Net deep learning models for optic disc and fovea segmentation on the IDRiD dataset. Achieved results that significantly outperform published benchmarks — real clinical impact for early retinal disease detection.",
    metrics: [
      { label: "Dice Score", value: "99.69%" },
      { label: "IoU", value: "99.4%" },
      { label: "vs Benchmark", value: "+8pts" },
    ],
    tags: ["PyTorch", "U-Net", "Medical Imaging", "REFUGE", "IDRiD"],
  ...
  },
  {
    ...
    description:
      "End-to-end trading signal system combining FinBERT sentiment analysis, LSTM price prediction, and Random Forest classification. Features a live Streamlit dashboard for real-time signals.",
    metrics: [
      { label: "Models", value: "3" },
      { label: "Stack", value: "FinBERT" },
      { label: "Interface", value: "Streamlit" },
    ],
    tags: ["Python", "FinBERT", "LSTM", "Random Forest", "Streamlit"],
    link: "https://github.com/eymen160",
    accent: "#2563eb",
    wide: false,
  },
  {
    ...
    description:
      "High-performance checkers engine in C using bitboard representation for O(1) move generation and state management. Optimized with bitwise operations for minimal memory footprint.",
    metrics: [
      { label: "Language", value: "C" },
      { label: "Ops", value: "Bitwise" },
  ...
  },
  {
    ...
    description:
      "Complete backend architecture for a recipe application with persistent MySQL storage. Modular SQL operations, secure Flask REST API, and clean relational schema design.",
    metrics: [
