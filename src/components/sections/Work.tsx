...
export default function Work() {
  ...
  return (
    <section id="work" style={{ background: "#0D0B0A", paddingTop: "clamp(80px,11vw,130px)", paddingBottom: "clamp(80px,11vw,130px)", position: "relative" }}>
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 40px" }}>
        ...
        <motion.div ref={headRef} initial={{ opacity: 0, y: 22 }} animate={headIv ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.75 }}
          ...
          <div>
            <p style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: "11px", color: "rgba(245,240,232,0.35)", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "16px" }}>Selected Work</p>
            <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 700, fontSize: "clamp(2.8rem, 7vw, 5.5rem)", lineHeight: 0.9, letterSpacing: "-0.02em", color: "#F5F0E8" }}>
              Projects &amp;<br /><em style={{ color: "rgba(245,240,232,0.3)" }}>Research</em>
            </h2>
          </div>
          <a href="https://github.com/eymen160" target="_blank" rel="noopener noreferrer"
            style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: "12px", color: "rgba(245,240,232,0.45)", textDecoration: "none", letterSpacing: "0.1em", textTransform: "uppercase", borderBottom: "1px solid rgba(245,240,232,0.18)", paddingBottom: "2px", transition: "color 0.2s" }}
          ...
          {projects.map((p, i) => {
            ...
            return (
              <motion.div key={p.num} ref={pRef}
                ...
                style={{ borderTop: "1px solid rgba(255,255,255,0.07)", padding: "clamp(28px,4vw,44px) 0", position: "relative" }}
                className="group">
                ...
                <div style={{ display: "grid", gridTemplateColumns: "80px 1fr auto", gap: "clamp(20px,3vw,48px)", alignItems: "start" }}>
                  ...
                  <div style={{ paddingTop: "4px" }}>
                    <span style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: "11px", color: "rgba(245,240,232,0.25)", letterSpacing: "0.15em" }}>{p.num}</span>
                  </div>

                  {/* Content */}
                  <div>
                    <div style={{ marginBottom: "10px" }}>
                      <span style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: "11px", color: "rgba(245,240,232,0.35)", letterSpacing: "0.16em", textTransform: "uppercase", marginRight: "16px" }}>{p.role}</span>
                      <span style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: "11px", color: "rgba(245,240,232,0.2)", letterSpacing: "0.1em" }}>{p.meta}</span>
                    </div>

                    <h3 style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 600, fontSize: "clamp(1.3rem, 2.8vw, 1.9rem)", lineHeight: 1.15, color: "#F5F0E8", letterSpacing: "-0.01em", marginBottom: "14px" }}>
                      {p.title}
                    </h3>

                    <p style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 300, fontSize: "0.9rem", lineHeight: 1.78, color: "rgba(245,240,232,0.45)", maxWidth: "560px", marginBottom: "18px" }}>
                      {p.description}
                    </p>

                    <div style={{ display: "flex", alignItems: "center", gap: "20px", flexWrap: "wrap" }}>
                      <span style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: "12px", color: "#C8A96A", letterSpacing: "0.04em" }}>
                        {p.highlight}
                      </span>
                      <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
                        {p.stack.map(t => (
                          <span key={t} style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: "11px", color: "rgba(245,240,232,0.3)", letterSpacing: "0.06em" }}>{t}</span>
                        ))}
                      </div>
                    </div>
                  </div>
                  ...
                  <div style={{ paddingTop: "4px" }}>
                    <a href={p.link} target="_blank" rel="noopener noreferrer"
                      style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: "12px", color: "rgba(245,240,232,0.3)", textDecoration: "none", letterSpacing: "0.1em", textTransform: "uppercase", transition: "color 0.2s", whiteSpace: "nowrap" }}
                      onMouseEnter={e => (e.currentTarget as HTMLAnchorElement).style.color = "#F5F0E8"}
                ...
                {/* Hover line */}
                <motion.div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: "1px", background: "rgba(200,169,106,0.5)", scaleX: 0, transformOrigin: "left" }}
